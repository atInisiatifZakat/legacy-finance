...
final class DisbursementController
{
    ...
    public function store(Request $request, StoreNewDisbursement $newDisbursement): JsonResponse
    {
        $data = $request->validate([
            ...
            'bank_name' => ['nullable', Rule::requiredIf($request->input('payment_type') === 'transfer')],
            'account_name' => ['nullable', Rule::requiredIf($request->input('payment_type') === 'transfer')],
            'account_number' => ['nullable', Rule::requiredIf($request->input('payment_type') === 'transfer')],
            'reff_id' => ['nullable', Rule::exists(Disbursement::class, 'id')],
            'advances_used_date' => ['nullable', 'array'],
